...
func UpdateTraining(id int, dto UpdateTrainingDTO) ([]rules.ValidationError, *training_models.Training) {
	...
	training := training_models.UpdateTraining(id, training_models.UpdateTrainingDTO{
		Type:                        dto.Type,
		Name:                        dto.Name,
